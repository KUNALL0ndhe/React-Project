...
const updateAccountdetails = asyncHandler ( async (req, res ) => {
   ...
   try {
     ...
     const user = await User.findByIdAndUpdate(
         ...
         {new: true} // this new will create us new object and return the updated value
     ).select("-password")
    ...
    throw new ApiError(401, "Update Account Details failed")
   }
...
const updateUserAvatar = asyncHandler ( async (req, res )=> {
   try {
    ...
    throw new ApiError(402, "Error while Updating Avatar")
   }
...
const updateUserCoverImage = asyncHandler ( async (req, res )=> {
    try {
     ...
     throw new ApiError(402, "Error while Updating Cover Image")
    }
